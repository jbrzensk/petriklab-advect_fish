function[ Predator ] = AdvectPredator_Happy( Predator,...
                                        Prey, ...
                                        current, ...
                                        happy, ...
                                        dt, ...
...
%                       : u = [ 1:n, 1:m, 1 ]
%                       : v = [ 1:n, 1:m, 2 ]
%   happy               : [n x m] binary array of hapiness
%   dt                  : timestep [s]
...
%% The core of the advection fish code.
    ...
    apparent_current_full = ApparentCurrentFull_happy( current, ...
                                                 happy, ...
                                                 fish_speed, ...
        ...
        for i=1:n
            ...
            if Fish_OG(i,j) > 0 % only care about cells with +fish
               ...
               if fish_speed <= 0
                   ...
                   Flux =  moveFishFunction_happy( Predator, ...
                                             Flux, ...
                                             Prey, ...
