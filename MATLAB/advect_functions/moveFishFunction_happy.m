function [ Flux ] = moveFishFunction_happy( Predator, Flux, Prey, apparent_current_full, idx, neighbors, dt, dx_m, dy_m, grid_mask, area )
...
[food_dir] = FoodExistFourWay( Prey, idx, neighbors );
...
Flux = semiLagrangianFish_happy( Predator, Flux, [i,j], food_dir, ...
