function [ dir ] = FoodExistFourWay( Food, idx, neighbors )
%% This finds food in four directions, and only looks for ANY food!
% Slight difference to FindMoreFoodFOurWay
%
% INPUTS:
...
% Date  : 30-06-2025
%
%  dir = ANY food comapred current cell = [ U D R L ]
% -------------------------------------------------------------------------
...
% Finds the direction of more food ONLY! 
    ...
    for k = 1:4
        ...
        if ~isnan( Food(ni, nj) )  && Food(ni,nj) >= 0
            dir(k) = 1;
        end
