function[ Predator ] = AdvectPredator_K( Predator,...
                                        Prey, ...
                                        current, ...
                                        K, ...
                                        dt, ...
...
%                       : u = [ 1:n, 1:m, 1 ]
%                       : v = [ 1:n, 1:m, 2 ]
%   K                   : Carrying Capacity of cell for fish N
%   dt                  : timestep [s]
...
%% The core of the advection fish code.
    ...
    apparent_current_full = ApparentCurrentFull_K( current, ...
                                                 overcrowded_fish_full, ...
                                                 fish_speed, ...
        ...
        for i=1:n
            ...
            if Fish_OG(i,j) > 0 % only care about cells with +fish
               ...
               if fish_speed <= 0
                   ...
                   Flux =  moveFishFunction_K( Predator, ...
                                             Flux, ...
                                             Prey, ...
