function [ Flux ] = moveFishFunction_K( Predator, Flux, Prey, apparent_current_full, idx, neighbors, dt, dx_m, dy_m, grid_mask, area )
...
Flux = semiLagrangianFish_K( Predator, Flux, [i,j], food_dir, ...
