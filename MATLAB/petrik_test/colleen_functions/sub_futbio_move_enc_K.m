...
function [Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,ENVR] = sub_futbio_move_enc_K(DY,ESM,GRD,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,param,neighbor)
    ...
    if nargin ~= 14
        warning('sub_futbio_move_enc_happy:InvalidNumInputs', ...
            'Expected 14 input arguments, but got %d.', nargin);
    end
...
%Lp: fraction of time large pis[n x m] binary array of hapinesscivores spends in pelagic
...
happySf = sub_happy_1Dto2D(GRD,Sf.nu,param);
happySp = sub_happy_1Dto2D(GRD,Sp.nu,param);
happySd = sub_happy_1Dto2D(GRD,Sd.nu,param);
happyMf = sub_happy_1Dto2D(GRD,Mf.nu,param);
happyMp = sub_happy_1Dto2D(GRD,Mp.nu,param);
happyMd = sub_happy_1Dto2D(GRD,Md.nu,param);
happyLp = sub_happy_1Dto2D(GRD,Lp.nu,param);
happyLd = sub_happy_1Dto2D(GRD,Ld.nu,param);
