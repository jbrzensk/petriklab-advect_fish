...
%============= PARAMETER TYPE ==========%
function param = make_param_newdt(param)
    %! Integration parameters
    param.DTday = param.DThr / 24.0;        % time step frac of day
    param.DTyear = (1/365.0) * param.DTday; % time step frac of year
    param.DTsec = param.DThr * 60 * 60;     % time step in seconds


    %! Which fishes harvested
    param.dfrate = param.frate * param.DTyear;
    param.MFsel = 1;
    param.LPsel = 1;
    param.LDsel = 1;
    param.Jsel  = 0.1;
    ...
    param.CC = 80; % 80 for CC, 0 for none
