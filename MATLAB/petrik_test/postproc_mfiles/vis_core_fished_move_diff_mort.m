...
title(['CORE stationary vs. move mort'])
print('-dpng',[ppath 'COREstationary_movemort_all_types_ts.png'])
...
title(['CORE stationary vs. move mort'])
print('-dpng',[ppath 'COREstationary_movemort_diff_all_types_ts.png'])
...
set(gcf,'renderer','painters')
title('Move mort - Stationary')
print('-dpng',[ppath 'COREstationary_movemort_global_BENT.png'])
...
set(gcf,'renderer','painters')
title('All F (g m^-^2)  Move mort - Stationary')
...
stamp('')
print('-dpng',[ppath 'COREstationary_movemort_All_subplot.png'])
